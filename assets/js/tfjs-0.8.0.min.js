! function(e) {
    ...
    return function() {
            ...
            var a = e("./environment"),
                ...
                h = function() {
                    ...
                    return e.prototype.runKernel = function(e, t, n) {
                        ...
                        var r = this.activeScope.keep,
                            i = p.extractTensorsFromContainer(e);
                        r = r.concat(i);
                        ...
                        var t = this;
                        return p.assert(p.isFunction(e), "The f passed in customGrad(f) must be a function."),
                            function() {
        ...
        5: [function(e, t, n) {
            (function(t) {
                ...
                function l(e) {
                    ...
                    if (2 !== e) return !1;
                    var t = i(e),
                        n = r(t, "WEBGL_get_buffer_sub_data_async");
                    return a(t), n
                }
                ...
                var y = ["webgl", "cpu"],
                    b = function() {
                        ...
                        return e.setBackend = function(e, t) {
                            ...
                            heading: "Environment"
                        })], e, "setBackend", null), h([g.doc({
                            heading: "Environment"
                        })], e, "getBackend", null), h([g.doc({
                            heading: "Performance",
                            subheading: "Memory"
                        })], e, "memory", null), e
                    }();
            ...
            var a = e("./doc"),
                ...
                c = function() {
                    ...
                    return e.gradScope = function(e, t) {
                        ...
                        return l.assert(l.isFunction(e), "The f passed in grad(f) must be a function"),
                            function(t, n) {
                        ...
                        return l.assert(l.isFunction(e), "The f passed in grads(f) must be a function"),
                            function(t, n) {
                        ...
                        return l.assert(l.isFunction(e), "The f passed in valueAndGrad(f) must be a function"),
                            function(t, n) {
                        ...
                        return l.assert(l.isFunction(e), "The f passed in valueAndGrads(f) must be a function"),
                            function(t, n) {
                                l.assert(Array.isArray(t) && t.every(function(e) {
                                    return e instanceof u.Tensor
                        ...
                        var i = o.ENV.engine.gradients(e, t, null, !0),
                            a = i.value,
                            s = i.grads;
        ...
        8: [function(e, t, n) {
            ...
            n.util = u;
            var l = e("./version");
            n.version_core = l.version;
            var c = e("./optimizers/adadelta_optimizer");
            n.AdadeltaOptimizer = c.AdadeltaOptimizer;
            var p = e("./optimizers/adagrad_optimizer");
            n.AdagradOptimizer = p.AdagradOptimizer;
            var h = e("./optimizers/adam_optimizer");
            n.AdamOptimizer = h.AdamOptimizer;
            var d = e("./optimizers/adamax_optimizer");
            n.AdamaxOptimizer = d.AdamaxOptimizer;
            var f = e("./optimizers/momentum_optimizer");
            n.MomentumOptimizer = f.MomentumOptimizer;
            var g = e("./optimizers/optimizer");
            n.Optimizer = g.Optimizer;
            var m = e("./optimizers/rmsprop_optimizer");
            n.RMSPropOptimizer = m.RMSPropOptimizer;
            var v = e("./optimizers/sgd_optimizer");
            n.SGDOptimizer = v.SGDOptimizer;
            var y = e("./tensor");
            n.Tensor = y.Tensor, n.TensorBuffer = y.TensorBuffer, n.variable = y.variable, n.Variable = y.Variable;
            var b = e("./types");
            n.Rank = b.Rank;
            var w = e("./weights_loader");
            n.loadWeights = w.loadWeights, r(e("./ops/ops")), r(e("./train")), r(e("./globals"));
            var x = e("./environment");
            n.ENV = x.ENV, n.Environment = x.Environment, n.setBackend = o.Environment.setBackend, n.getBackend = o.Environment.getBackend, n.memory = o.Environment.memory;
            var E = e("./doc");
            n.doc = E.doc, n.nextFrame = i.BrowserUtil.nextFrame
        }, {
            "./browser_util": 1,
            "./doc": 3,
            "./environment": 5,
            "./globals": 6,
            "./ops/ops": 62,
            "./optimizers/adadelta_optimizer": 74,
            "./optimizers/adagrad_optimizer": 75,
            "./optimizers/adam_optimizer": 76,
            "./optimizers/adamax_optimizer": 77,
            "./optimizers/momentum_optimizer": 78,
            "./optimizers/optimizer": 79,
            "./optimizers/rmsprop_optimizer": 81,
            "./optimizers/sgd_optimizer": 82,
            "./tensor": 85,
            "./test_util": 87,
            "./train": 89,
            "./types": 90,
            ...
            var a = e("seedrandom"),
                ...
                v = function() {
                    ...
                    return e.prototype.register = function(e, t, n) {
                        ...
                        var n;
                        if (e instanceof ImageData) n = e.data;
                        else if (e instanceof HTMLCanvasElement) n = e.getContext("2d").getImageData(0, 0, e.width, e.height).data;
                        else {
                        ...
                        if (4 === t) r = new Int32Array(n);
                            ...
                            for (var a = 0; a < i; a++)
                                for (var o = 0; o < t; ++o) r[a * t + o] = n[4 * a + o]
                        }
                        ...
                        return r(this, void 0, void 0, function() {
                            var t, n;
                            return i(this, function(r) {
                                return t = performance.now(), e(), n = performance.now() - t, [2, {
                                    kernelMs: n
                                }]
                            })
                        })
                        ...
                        for (var i = n ? e.shape[0] : e.shape[1], a = n ? e.shape[1] : e.shape[0], o = r ? t.shape[0] : t.shape[1], s = function(e, t, n) {
                                ...
                                return e.get(n, t)
                            }, l = n ? u : s, p = r ? u : s, h = new Float32Array(a * o), d = 0, f = 0; f < a; ++f)
                            for (var g = 0; g < o; ++g) {
                        ...
                        for (var i = e.dataSync(), a = t.dataSync(), o = n.dataSync(), s = c.zeros(t.shape, r), u = s.dataSync(), l = 0, p = 0 === e.rank || e.rank > 1 || 1 === t.rank ? 1 : t.shape[1], h = 0; h < i.length; h++)
                            for (var d = 0; d < p; d++) 1 === i[h] ? u[l++] = a[h] : u[l++] = o[h];
                        return s
                        ...
                        for (var n = e.dataSync(), r = [], i = 0; i < n.length; i++) r.push({
                            value: n[i],
                            index: i
                        });
                        r.sort(function(e, t) {
                        ...
                        return {
                            values: c.tensor1d(a, e.dtype),
                            indices: c.tensor1d(o, "int32")
                        }
                                        ...
                                        for (var m = g * n.strideWidth - u, v = 0, y = 0; y < r; y++) {
                                            ...
                                            if (!(b < 0 || b >= n.inHeight))
                                                for (var w = 0; w < i; w++) {
                                                    var x = m + w * o;
                                                    if (!(x < 0 || x >= n.inWidth))
                                                        for (var E = 0; E < n.inChannels; ++E) v += e.get(p, b, x, E) * t.get(y, w, E, h)
                                                }
                                        }
                                        l.set(v, p, d, g, h)
                                    }
                            ...
                            for (var h = 0; h < n.inChannels; ++h)
                                for (var d = 0; d < n.inHeight; ++d)
                                    for (var f = d - o, g = Math.max(0, Math.ceil(f / s)), m = Math.min(n.outHeight, (r + f) / s), v = 0; v < n.inWidth; ++v) {
                                        for (var y = v - a, b = Math.max(0, Math.ceil(y / u)), w = Math.min(n.outWidth, (i + y) / u), x = 0, E = g; E < m; ++E)
                                            for (var _ = E * s - f, A = b; A < w; ++A)
                                                for (var S = A * u - y, O = 0; O < n.outChannels; ++O) x += e.get(p, E, A, O) * t.get(r - 1 - _, i - 1 - S, h, O);
                                        l.set(x, p, d, v, h)
                                    }
                        return l.toTensor()
                            ...
                            for (var p = 0; p < t.inChannels; ++p)
                                for (var h = 0; h < t.outHeight; ++h)
                                    for (var d = h * r - s, f = Math.max(0, d), g = Math.min(t.inHeight, a + d), m = 0; m < t.outWidth; ++m) {
                                        for (var v = m * i - u, y = Math.max(0, v), b = Math.min(t.inWidth, o + v), w = Number.NEGATIVE_INFINITY, x = -1, E = f; E < g; ++E)
                                            for (var _ = E - d, A = y; A < b; ++A) {
                                                var S = A - v,
                                                    O = e.get(l, E, A, p);
                                                O > w && (w = O, x = _ * o + S)
                                            }
                        ...
                        for (var r = this.maxPoolPositions(t, n), i = n.strideHeight, a = n.strideWidth, o = n.filterHeight, s = n.filterWidth, u = s - 1 - n.padInfo.left, l = o - 1 - n.padInfo.top, p = c.buffer(t.shape, "float32"), h = 0; h < n.batchSize; ++h)
                            for (var d = 0; d < n.inChannels; ++d)
                                for (var f = 0; f < n.inHeight; ++f)
                                    for (var g = 0; g < n.inWidth; ++g) {
                                        for (var m = f - l, v = g - u, y = 0, b = 0; b < o; ++b) {
                                            var w = (m + b) / i;
                                            if (!(w < 0 || w >= n.outHeight || Math.floor(w) !== w))
                                                for (var x = 0; x < s; ++x) {
                                                    var E = (v + x) / a;
                        ...
                        for (var o = c.buffer(e.shape, "float32"), s = t, u = o.shape[1] - 1, l = o.shape[2] - 1, p = o.shape[3] - 1, h = 0; h < o.shape[0]; h++)
                            for (var d = 0; d <= o.shape[1]; d++)
                                for (var f = 0; f < o.shape[2]; f++)
                                    for (var g = 0; g < o.shape[3]; g++) {
                                        var m = "withinChannel" === a ? function(t, n, r, i) {
                                                for (var a = 0, o = Math.max(0, n - s); o <= Math.min(n + s, u); o++)
                                                    for (var c = Math.max(0, r - s); c <= Math.min(r + s, l); c++) a += Math.pow(e.get(t, o, c, i), 2);
                                                return a
                                            ...
                                            v = e.get(h, d, f, g) * Math.pow(n + r * m, -i);
                                        o.set(v, h, d, f, g)
                                    }
                        return o.toTensor()
        ...
        10: [function(e, t, n) {
            ...
            n.castTensor = function(e, t, n) {
                if (!r.util.hasEncodingLoss(e.dtype, t)) return r.Tensor.make(e.shape, {
                    dataId: e.dataId
                }, t);
        ...
        11: [function(e, t, n) {
            ...
            var s = e("../environment"),
                ...
                h = e("../util"),
                d = e("./backend_util"),
                f = e("./webgl/argminmax_gpu"),
                g = e("./webgl/avg_pool_backprop_gpu"),
                m = e("./webgl/batchnorm_gpu"),
                v = e("./webgl/binaryop_gpu"),
                y = e("./webgl/binaryop_gpu"),
                b = e("./webgl/clip_gpu"),
                w = e("./webgl/concat_gpu"),
                x = e("./webgl/conv_backprop_gpu"),
                E = e("./webgl/conv_gpu"),
                _ = e("./webgl/conv_gpu_depthwise"),
                A = e("./webgl/from_pixels_gpu"),
                S = e("./webgl/gather_gpu"),
                O = e("./webgl/gpgpu_context"),
                T = e("./webgl/gpgpu_math"),
                k = e("./webgl/logical_gpu"),
                C = e("./webgl/lrn_gpu"),
                N = e("./webgl/max_pool_backprop_gpu"),
                R = e("./webgl/mulmat_gpu"),
                I = e("./webgl/multinomial_gpu"),
                z = e("./webgl/onehot_gpu"),
                M = e("./webgl/pad_gpu"),
                D = e("./webgl/pool_gpu"),
                L = e("./webgl/reduce_gpu"),
                P = e("./webgl/resize_bilinear_gpu"),
                F = e("./webgl/reverse_gpu"),
                V = e("./webgl/slice_gpu"),
                B = e("./webgl/tex_util"),
                j = e("./webgl/texture_manager"),
                U = e("./webgl/tile_gpu"),
                G = e("./webgl/transpose_gpu"),
                W = e("./webgl/unaryop_gpu"),
                q = e("./webgl/unaryop_gpu"),
                K = e("./webgl/webgl_util"),
                H = function() {
                    function e(e, t) {
                    ...
                    return e.prototype.register = function(e, t, n) {
                        ...
                        var a = new A.FromPixelsProgram(r),
                        ...
                        var r = new V.SliceProgram(n),
                            i = r.getCustomSetupFunc(t);
                        ...
                        var r = e.shape[0],
                            i = e.shape[1],
                            a = {
                                windowSize: l.computeOptimalWindowSize(i),
                                inSize: i,
                                batchSize: r
                            },
                        ...
                        var a = {
                            ...
                            o = new f.ArgMinMaxProgram(a, t, null == n),
                            s = o.outputShape,
                            u = s[0],
                            c = s[1],
                            p = this.makeOutputArray([u, c], "int32"),
                            h = [e];
                        ...
                        var n = u.computeOutAndReduceShapes(e.shape, t),
                            r = n[0],
                            i = n[1],
                            a = h.sizeFromShape(i),
                            o = e.as2D(-1, a),
                            s = p.sumOutType(e.dtype);
                        ...
                        var i = new k.WhereProgram(e.rank, t.shape, t.rank),
                            a = this.makeOutputArray(i.outputShape, r);
                        ...
                        var t = new q.UnaryOpProgram(e.shape, W.TO_INT),
                        ...
                        var n = new D.Pool2DProgram(t, "max", !1),
                            r = this.makeOutputArray(n.outputShape, e.dtype);
                        return this.compileAndRun(n, [e], r)
                    }, e.prototype.minPool = function(e, t) {
                        var n = new D.Pool2DProgram(t, "min", !1),
                            r = this.makeOutputArray(n.outputShape, e.dtype);
                        return this.compileAndRun(n, [e], r)
                    }, e.prototype.avgPool = function(e, t) {
                        var n = new D.Pool2DProgram(t, "avg", !1),
                            r = this.makeOutputArray(n.outputShape, "float32");
                        return this.compileAndRun(n, [e], r)
                    }, e.prototype.maxPoolBackprop = function(e, t, n) {
                        var r = new D.Pool2DProgram(n, "max", !0),
                            i = this.compileAndRun(r, [t]),
                            a = new N.MaxPool2DBackpropProgram(n),
                            o = this.makeOutputArray(a.outputShape, t.dtype),
                            s = this.compileAndRun(a, [e, i], o);
                        return i.dispose(), s
                    }, e.prototype.avgPoolBackprop = function(e, t, n) {
                        var r = new g.AvgPool2DBackpropProgram(n),
                            i = this.makeOutputArray(r.outputShape, t.dtype);
                        ...
                        var r = e.shape[0],
                            i = e.shape[1],
                            a = new I.MultinomialProgram(r, i, t),
                            o = this.makeOutputArray(a.outputShape, "int32"),
                        ...
                        var a = t.map(function(e) {
                            return i.uploadToGPU(e.dataId), {
                                tensor: e,
                                texData: i.texData.get(e.dataId)
                            }
                        });
        ...
        22: [function(e, t, n) {
            ...
            var i = e("./shader_compiler"),
                a = function() {
                    return function(e, t, n) {
                        this.variableNames = ["A", "indices"];
                        var a = e.slice();
                        a[n] = t, this.outputShape = a, this.rank = a.length;
                        var o = i.getCoordsDataType(this.rank),
                            s = r(e, n);
            ...
            var a = e("../../environment"),
                ...
                c = function() {
                    ...
                    return e.prototype.dispose = function() {
                        ...
                        this.throwIfDisposed();
                        var r = u.getPackedMatrixTextureShapeWidthHeight(t, n),
                            i = r[0],
                            a = r[1];
                        ...
                        var r = this.getQueryTimerExtensionWebGL1(),
                            i = r.getQueryObjectEXT(e, r.QUERY_RESULT_EXT);
                        return i / 1e6
        ...
        25: [function(e, t, n) {
            ...
            n.getWebGLContextAttributes = r, n.createWebGLContext = function(e) {
                ...
                var o, s = f.getUnpackedMatrixTextureShapeWidthHeight(n, r),
                    l = s[0],
                    c = s[1];
                if (d.ENV.get("WEBGL_FLOAT_TEXTURE_ENABLED")) {
                ...
                i = function() {
                    return function(e, t, n) {
                        ...
                        var i = e.length,
                            ...
                            u = ["coords[0]", "coords[1]", "coords[2]", "coords[3]"].slice(0, i);
        ...
        37: [function(e, t, n) {
            ...
            function y(e, t, n, r) {
                ...
                var s, u = A.getBroadcastDims(e.shapeInfo.logicalShape, t.logicalShape),
                    l = a - i;
            ...
            function b(e, t, n) {
                var r = e.shapeInfo.texShape,
                    ...
                    o = "get" + a + "AtOutCoords",
                    s = A.getBroadcastDims(e.shapeInfo.logicalShape, t.logicalShape),
            ...
            var i = e("./shader_compiler"),
                a = function() {
                    function e(e) {
                        ...
                        var t = i.getCoordsDataType(this.rank),
                            n = r(this.rank);
        ...
        39: [function(e, t, n) {
            ...
            var s = (n.FLOAT_MAX - n.FLOAT_MIN) / 255,
            ...
            n.BYTE_NAN_VALUE = 0, n.encodeFloatArray = function(e) {
                ...
                var r = e.length * n / 4;
                if (t.length < r) throw new Error("matrix length (" + t.length + ") must be >= " + r);
                for (var i = 0, a = 0; a < e.length; a += 4)
                ...
                if (c)
                    for (var w = n - 1, m = 4 * (u - 1), x = 2 * n, f = 4 * u, v = 0; v < d; ++v) r[m] = e[w], r[m + 2] = e[w + n], w += x, m += f;
                if (p)
                    for (var w = (t - 1) * n, m = (l - 1) * u * 4, b = 0; b < h; ++b) r[m++] = e[w++], r[m++] = e[w++], m += 2;
                ...
                if (o)
                    for (var g = 4 * (p - 1), b = n - 1, d = 4 * p, f = 2 * n, y = 0; y < l; ++y) r[b] = e[g], r[b + n] = e[g + 2], g += d, b += f;
                if (s)
                    for (var g = (h - 1) * p * 4, b = (t - 1) * n, w = 0; w < u; ++w) r[b++] = e[g++], r[b++] = e[g++], g += 2;
        ...
        44: [function(e, t, n) {
            ...
            n.createProgram = function(e) {
                ...
                var u = e.getAttribLocation(t, n); - 1 !== u && (i(e, function() {
            ...
            var u = e("../doc"),
                ...
                y = function() {
                    ...
                    return e.tensor = function(e, t, n) {
                        ...
                        return null != t && 1 !== r.length && h.assertShapesMatch(t, r, "Error creating a new Tensor. Inferred shape (" + r + ") does not match the provided shape (" + t + "). "), h.isTypedArray(e) || Array.isArray(e) || (e = [e]), t = t || r, c.Tensor.make(t, {
                            values: a(e, n)
                        }, n)
                        ...
                        return r.fill(t), c.Tensor.make(e, {
                            values: r
                        }, n)
                        ...
                        var o = 1 === a ? e.as2D(1, -1) : e,
                            s = l.ENV.engine.runKernel(function(e) {
                        ...
                        return l.ENV.engine.runKernel(function(e) {
                            ...
                            return {
                                x: function() {
                                    var i = e.zerosLike(t);
                                    if (1 === t.rank)
                                        for (a = 0; a < n[0]; ++a) i = i.add(r.slice([a * t.shape[0]], [t.shape[0]]));
                                    else if (2 === t.rank)
                                        for (a = 0; a < n[0]; ++a)
                                            for (o = 0; o < n[1]; ++o) i = i.add(r.slice([a * t.shape[0], o * t.shape[1]], [t.shape[0], t.shape[1]]));
                                    else if (3 === t.rank)
                                        for (a = 0; a < n[0]; ++a)
                                            for (o = 0; o < n[1]; ++o)
                                                for (s = 0; s < n[2]; ++s) i = i.add(r.slice([a * t.shape[0], o * t.shape[1], s * t.shape[2]], [t.shape[0], t.shape[1], t.shape[2]]));
                                    else {
                                        if (4 !== t.rank) throw new Error("Gradient for tile operation is not implemented for rank-" + t.rank + " tensors yet.");
                                        for (var a = 0; a < n[0]; ++a)
                                            for (var o = 0; o < n[1]; ++o)
                                                for (var s = 0; s < n[2]; ++s)
                                                    for (var u = 0; u < n[3]; ++u) i = i.add(r.slice([a * t.shape[0], o * t.shape[1], s * t.shape[2], u * t.shape[3]], [t.shape[0], t.shape[1], t.shape[2], t.shape[3]]))
                                    }
                                    return i
                                }
                            }
                        ...
                        void 0 === t && (t = 0), h.assert(e.length >= 2, "Pass at least two tensors to dl.stack");
                        var n = e[0].rank,
                            r = e[0].shape,
                            i = e[0].dtype;
                    ...
                    return e.add = function(e, t) {
                        ...
                        return a.ENV.engine.runKernel(function(n) {
                            ...
                            return {
                                a: function() {
                                    var t = r,
                                        i = s.getReductionAxes(e.shape, n);
                                    return i.length > 0 && (t = t.sum(i)), t.reshape(e.shape)
                                },
                                b: function() {
                                    var e = r,
                                        i = s.getReductionAxes(t.shape, n);
                        ...
                        return a.ENV.engine.runKernel(function(n) {
                            ...
                            return {
                                base: function() {
                                    var r = t.toFloat(),
                                        i = r.mul(e.toFloat().pow(r.sub(l.scalar(1))));
                        ...
                        return a.ENV.engine.runKernel(function(e) {
                            ...
                            return {
                                a: function() {
                                    var a = e.add(l.square(t), l.square(n)),
                                        o = i.mul(n.div(a)),
        ...
        49: [function(e, t, n) {
            ...
            Object.defineProperty(n, "__esModule", {
                value: !0
            }), n.getBroadcastDims = function(e, t) {
        ...
        51: [function(e, t, n) {
            ...
            function r(e, t, n) {
                ...
                var r = l.computeOutShape(e.shape, t.shape, n),
            ...
            var a = e("../doc"),
                ...
                p = function() {
                    ...
                    return e.concat1d = function(t) {
                        ...
                        void 0 === t && (t = 0), s.assert(e.length >= 2, "Pass at least two tensors to concat");
                        for (var n = e[0], i = u.parseAxisParam(t, n.shape), a = 1; a < e.length; ++a) n = r(n, e[a], i[0]);
                        return n
                    }, i([a.doc({
                        heading: "Tensors",
                        subheading: "Slicing and Joining"
            ...
            var s = e("../doc"),
                ...
                h = function() {
                    ...
                    return e.conv1d = function(t, n, r, i, o, s, u) {
                        ...
                        var f = c.computeConv2DInfo(o, n.shape, r, 1, i, a),
                        ...
                        heading: "Operations",
                        subheading: "Convolution"
                    }), p.operation], e, "depthwiseConv2d", null), e
                }();
            n.ConvOps = h
        }, {
            "../doc": 3,
        ...
        54: [function(e, t, n) {
            ...
            function r(e, t, n, r, i, a, l, c) {
                ...
                var p = [-1, -1, -1, -1],
                    ...
                    f = p[2],
                    g = p[3];
                if ("channelsLast" === c) h = e[0], d = e[1], f = e[2], g = e[3];
                else {
            ...
            n.computePool2DInfo = function(e, t, n, i, a, s) {
                ...
                var u, l = o(t),
                    c = l[0],
                    p = l[1];
                if ("channelsLast" === s) u = [c, p, e[3], e[3]];
                else {
            ...
            var i = e("../doc"),
                ...
                o = function() {
                    ...
                    return e.multiRNNCell = function(e, t, n, r) {
                        ...
                        var o = r.concat(a, 1).matMul(t).add(n),
                            s = o.shape[0],
                            u = o.shape[1] / 4,
                            l = [s, u],
                            c = o.slice([0, 0], l),
            ...
            var i = e("../doc"),
                ...
                u = function() {
                    ...
                    return e.matMul = function(e, t, n, r) {
                        ...
                        var i = n ? e.shape[0] : e.shape[1],
                            s = r ? t.shape[1] : t.shape[0];
            ...
            var i = e("../doc"),
                ...
                l = function() {
                    ...
                    return e.maxPool = function(t, n, r, i, u) {
                        ...
                        var p = s.computePool2DInfo(l.shape, n, r, i, u),
                        ...
                        var h = s.computePool2DInfo(l.shape, n, r, i, u),
                            d = a.ENV.engine.runKernel(function(e) {
                        ...
                        var c = s.computePool2DInfo(u.shape, t, n, r, i),
                            p = a.ENV.engine.runKernel(function(e) {
                        ...
                        var p = s.computePool2DInfo(l.shape, n, r, i),
                            h = a.ENV.engine.runKernel(function(e) {
                        ...
                        var p = s.computePool2DInfo(u.shape, n, r, i),
                            h = a.ENV.engine.runKernel(function(e) {
        ...
        65: [function(e, t, n) {
            ...
            Object.defineProperty(n, "__esModule", {
                value: !0
            }), n.PARALLELIZE_THRESHOLD = 30, n.computeOptimalWindowSize = function(e) {
            ...
            var i = e("../doc"),
                ...
                p = function() {
                    ...
                    return e.logSumExp = function(e, t, n) {
                        ...
                        var r = u.parseAxisParam(t, e.shape),
                            i = r,
                            o = u.getAxesPermutation(i, e.rank);
                        ...
                        void 0 === t && (t = null);
                        var n = u.parseAxisParam(t, e.shape),
                            r = u.getAxesPermutation(n, e.rank);
        ...
        68: [function(e, t, n) {
            ...
            Object.defineProperty(n, "__esModule", {
                value: !0
            }), n.SELU_SCALEALPHA = 1.7580993408473768, n.SELU_SCALE = 1.0507009873554805
        }, {}],
        69: [function(e, t, n) {
            "use strict";
            var r = this && this.__decorate || function(e, t, n, r) {
                ...
                c = function() {
                    ...
                    return e.softmax = function(e, t) {
                        ...
                        return a.customGrad(function(e, t) {
                            var r = t.softmax(n);
                            return {
                                value: l.scalar(1e-5).add(r).log().mul(e).neg().sum([n]),
                                gradFunc: function(t) {
            ...
            var i = e("../doc"),
                ...
                l = function() {
                    ...
                    return e.transpose = function(e, t) {
                        ...
                        heading: "Operations",
                        subheading: "Matrices"
                    }), u.operation], e, "transpose", null), e
                }();
            n.TransposeOps = l
        }, {
            "../doc": 3,
                ...
                d = function() {
                    ...
                    return e.neg = function(e) {
                        ...
                        return s.ENV.engine.runKernel(function(t) {
                            ...
                            return {
                                x: function() {
                                    var n = e.greater(c.scalar(0)),
                                        r = c.scalar(h.SELU_SCALEALPHA),
                                        i = c.scalar(h.SELU_SCALE),
                                        a = t.mul(i),
            ...
            var i = e("../environment"),
                ...
                s = function(e) {
                    ...
                    return r(t, e), t.prototype.applyGradients = function(e) {
                        ...
                        a.tidy(function() {
                            var n = t.one.sub(t.accBeta1),
                                r = t.c.div(t.one.add(t.decay.mul(t.iteration)));
                            for (var a in e) {
                                var s = i.ENV.engine.registeredVariables[a];
                                if (null == t.accumulatedFirstMoment[a]) {
                                    u = !1;
        ...
        80: [function(e, t, n) {
            ...
            var i = e("../doc"),
                ...
                h = function() {
                    ...
                    }, e.rmsprop = function(e, t, n, r) {
                        return void 0 === t && (t = .9), void 0 === n && (n = 0), void 0 === r && (r = 1e-8), new c.RMSPropOptimizer(e, t, n, r)
            ...
            "../doc": 3,
            "./adadelta_optimizer": 74,
            "./adagrad_optimizer": 75,
            "./adam_optimizer": 76,
            "./adamax_optimizer": 77,
            "./momentum_optimizer": 78,
            "./rmsprop_optimizer": 81,
            "./sgd_optimizer": 82
        }],
        81: [function(e, t, n) {
            "use strict";
            ...
            var i = e("../environment"),
                ...
                s = function(e) {
                    function t(t, n, r, i) {
                        void 0 === n && (n = .9), void 0 === r && (r = 0), void 0 === i && (i = 1e-8);
                        var s = e.call(this) || this;
                        return s.learningRate = t, s.accumulatedMeanSquares = {}, s.accumulatedMoments = {}, s.c = a.keep(o.scalar(t)), s.epsilon = a.keep(o.scalar(i)), s.decay = a.keep(o.scalar(n)), s.momentum = a.keep(o.scalar(r)), s.oneMinusDecay = a.keep(o.scalar(1 - n)), s
                    }
                    return r(t, e), t.prototype.applyGradients = function(e) {
                        var t = this,
                            n = this;
                        for (var r in e) ! function(r) {
                            ...
                            var u = n.accumulatedMeanSquares[r],
                                l = n.accumulatedMoments[r],
                                c = e[r];
                            a.tidy(function() {
                                var e = t.decay.mul(u).add(t.oneMinusDecay.mul(c.square())),
                                    n = t.momentum.mul(l).add(t.c.mul(c).div(e.add(t.epsilon).sqrt()));
                                t.accumulatedMeanSquares[r].assign(e), t.accumulatedMoments[r].assign(n);
                                var i = s.sub(n);
                                s.assign(i)
                            })
                        }(r)
                ...
                s = function(e) {
                    ...
                    return r(t, e), t.prototype.applyGradients = function(e) {
                        ...
                        Object.keys(e).forEach(function(n) {
                            var r = e[n],
                                o = i.ENV.engine.registeredVariables[n];
                            a.tidy(function() {
        ...
        84: [function(e, t, n) {
            ...
            n.getFilteredNodesXToY = function(e, t, n) {
                ...
                for (var p = {}, a = e.length - 1; a >= 0; a--) {
                    var h = (g = e[a]).inputs,
                        d = [];
                    for (d.push(g.output), l = 0; l < d.length; l++)
                        if (c[d[l].id]) {
        ...
        85: [function(e, t, n) {
            ...
            var u = e("./doc"),
                ...
                d = function() {
                    function e(e, t, n) {
                        if (this.shape = e, this.dtype = t, this.values = n, null != n) {
                            var i = n.length,
                                a = h.sizeFromShape(e);
                            h.assert(i === a, "Length of values '" + i + "' does not match the size inferred by the shape '" + a + "'")
                        }
                        this.values = n || h.getTypedArrayFromDType(t, h.sizeFromShape(e)), this.strides = r(e), this.size = h.sizeFromShape(e)
                    }
                    return e.prototype.set = function(e) {
                        ...
                        heading: "Tensors",
                        subheading: "Creation"
                    })], e.prototype, "toTensor", null), e = a([u.doc({
                        heading: "Tensors",
                        subheading: "Classes"
                    })], e)
                }();
            ...
            var f = function() {
                ...
                return t = e, e.make = function(e, n, r) {
                    ...
                    return p.tensorToString(this, !0)
                    ...
                    heading: "Tensors",
                    subheading: "Classes"
                })], e.prototype, "toString", null), e = t = a([u.doc({
                    heading: "Tensors",
                    subheading: "Classes"
                })], e);
                var t
        ...
        86: [function(e, t, n) {
            ...
            function r(e) {
                ...
                if (e.rank > 1)
                    for (var o = 0; o < n / r; o++)
                        for (var s = o * r, u = 0; u < r; u++) a[u] = Math.max(a[u], i(t[s + u], 0).length);
                return a
            }
            ...
            function a(e, t, n, r, o) {
                ...
                if (1 === c) {
                    if (l > s) {
                        var p = Array.from(e.subarray(0, u)),
                            h = Array.from(e.subarray(l - u, l));
        ...
        87: [function(e, t, n) {
            ...
            var o = e("./environment"),
                s = e("./kernels/backend_cpu"),
                u = e("./kernels/backend_webgl"),
                l = e("./tensor"),
                c = e("./util");
            n.WEBGL_ENVS = [{
                BACKEND: "webgl",
                ...
                BACKEND: "cpu"
            }], n.ALL_ENVS = n.WEBGL_ENVS.concat(n.CPU_ENVS), n.TEST_EPSILON = .001, n.expectArraysClose = r, n.expectArraysEqual = function(e, t) {
                return r(e, t, 0)
        ...
        89: [function(e, t, n) {
            ...
            var r = e("./optimizers/adadelta_optimizer"),
            ...
            "./optimizers/adamax_optimizer": 77,
            "./optimizers/momentum_optimizer": 78,
            "./optimizers/optimizer_constructors": 80,
            "./optimizers/rmsprop_optimizer": 81,
            "./optimizers/sgd_optimizer": 82
        }],
        90: [function(e, t, n) {
        ...
        91: [function(e, t, n) {
            ...
            n.shuffle = r, n.clamp = function(e, t, n) {
                ...
                for (var r = 0; r < e.length; r++)
                    if (l(e[r], t)) throw Error("The result of the '" + n + "' has NaNs.")
            }, n.flattenNameArrayMap = function(e, t) {
                var n = [];
                if (e instanceof d.Tensor) n.push(e);
                else
                    for (var r = e, i = 0; i < t.length; i++) n.push(r[t[i]]);
                return n
                            ...
                            case 2:
                                return m = i.sent(), v = {}, y = 0, d.forEach(function(t) {
                                    ...
                                    l[t].forEach(function(e) {
                                        ...
                                        if ("float32" === e.manifestEntry.dtype) t = new Float32Array(n);
                                        else {
        ...
        96: [function(e, t, n) {
            ...
            function r() {
                for (var e in ne)
                    for (var t in ne[e]) ne[e][t].dispose(), delete ne[e][t]
            }
            ...
            function v(e, t, n) {
                for (var r = [], i = 0; i < e; ++i)
                    for (var a = 0; a < e; ++a) r.push(i === a ? 1 : 0);
            ...
            function P(e, t, n) {
                ...
                var r, i = t.shape;
                if (5 === o(e)) "channelsFirst" === n ? r = 1 === i.length ? e.add(t.reshape([1, i[0], 1, 1, 1])) : e.add(t.reshape([1, i[3], i[0], i[1], i[2]])) : "channelsLast" === n && (r = 1 === i.length ? e.add(t.reshape([1, 1, 1, 1, i[0]])) : e.add(t.reshape([1].concat(i))));
                else if (4 === o(e)) "channelsFirst" === n ? r = 1 === i.length ? e.add(t.reshape([1, i[0], 1, 1])) : e.add(t.reshape([1, i[2], i[0], i[1]])) : "channelsLast" === n && (r = 1 === i.length ? e.add(t.reshape([1, 1, 1, i[0]])) : e.add(t.reshape([1].concat(i))));
                else if (3 === o(e)) "channelsFirst" === n ? r = 1 === i.length ? e.add(t.reshape([1, i[0], 1])) : e.add(t.reshape([1, i[1], i[0]])) : "channelsLast" === n && (r = 1 === i.length ? e.add(t.reshape([1, 1, i[0]])) : e.add(t.reshape([1].concat(i))));
                else {
            ...
            function V(e, t, n, r, i, a, o) {
                if (void 0 === r && (r = 1), void 0 === i && (i = "valid"), void 0 === o && (o = 1), null == a && (a = $.imageDataFormat()), H.checkDataFormat(a), 1 !== o) throw new X.NotImplementedError("dilationRate = " + o + " is not implemented for 1D convolution yet.");
                if (3 !== e.shape.length) throw new X.ValueError("The input of a conv1dWithBias operation should be 3, but is " + e.shape.length + " instead.");
                ...
                var s = W.conv1d(e, t, r, "same" === i ? "same" : "valid");
                return null != n && (s = P(s, n)), s
            }

            function B(e, t, n, r, i, a, s) {
                if (void 0 === r && (r = [1, 1]), void 0 === i && (i = "valid"), null == a && (a = $.imageDataFormat()), H.checkDataFormat(a), null != s) throw new X.NotImplementedError("Support for non-default dilation rate is not implemented yet.");
                if (3 !== o(e) && 4 !== o(e)) throw new X.ValueError("conv2dWithBias expects input to be of rank 3 or 4, but received " + o(e) + ".");
                ...
                return u = W.conv2d(u, t, r, "same" === i ? "same" : "valid"), null != n && (u = P(u, n)), "channelsFirst" === a && (u = W.transpose(u, [0, 3, 1, 2])), u
            }
            ...
            function G(e, t) {
                var n = W.maximum(t, W.zerosLike(t)),
                    r = W.mul(t, e),
                    a = W.log(W.add(i(1), W.exp(W.neg(W.abs(t)))));
                return W.add(W.sub(n, r), a)
            }
            Object.defineProperty(n, "__esModule", {
                value: !0
            });
            var W = e("@tensorflow/tfjs-core"),
                q = e("@tensorflow/tfjs-core"),
                K = e("underscore"),
                H = e("../common"),
                X = e("../errors"),
                Y = e("../types"),
                Q = e("../utils/generic_utils"),
            ...
            n.getScalar = i, n.epsilon = Z.epsilon, n.isBackendSymbolic = function() {
                return !1
                ...
                if (null == t && (t = [
                        [1, 1],
                        [1, 1]
                    ]), 2 !== t.length || 2 !== t[0].length || 2 !== t[1].length) throw new X.ValueError("spatial2dPadding expects `padding` to be an Array of two Arrays, each of which is an Array of two integers.");
                ...
                for (var t = e.shape[0], n = e.shape[1], r = v(t), i = e, a = q.tensor2d([
                        [1]
                    ], [1, 1]), o = 0; o < n; ++o) {
                ...
                void 0 === a && (a = .001);
                var s;
                if (2 === o(e)) s = W.batchNormalization2d(e, t, n, a);
                else if (3 === o(e)) s = W.batchNormalization3d(e, t, n, a);
                else {
            ...
            "../errors": 103,
            "../types": 124,
            "../utils/generic_utils": 126,
            "../utils/math_utils": 127,
            "./common": 95,
            "@tensorflow/tfjs-core": 8,
            underscore: 139
        }],
                    ...
                    return a(this, void 0, void 0, function() {
                        ...
                        return o(this, function(o) {
                            switch (o.label) {
                                case 0:
                                    e = [], t = [], n = [];
                                    for (r in this.history)
                                        for (i = this.history[r], a = 0; a < i.length; ++a) "number" != typeof i[a] && (s = i[a], e.push(s.data()), t.push(r), n.push(a));
        ...
        98: [function(e, t, n) {
            ...
            n.nameScope = function(e, t) {
                ...
                e = r() + e, s.has(e) || s.set(e, 0);
                var t = s.get(e);
                return s.set(e, s.get(e) + 1), t > 0 ? e + "_" + t : e
            };
                ...
                u = function() {
                    function e(t) {
                        if (this.id2Value = {}, t instanceof e)
                            for (var n in t.id2Value) this.id2Value[n] = t.id2Value[n];
                        else {
                            if (null == t) return;
        ...
        101: [function(e, t, n) {
            ...
            function o(e, t, n) {
                ...
                return h.Tensor.make(t, {
                    values: 0 === t.length ? n : d.flatten(n)
                }, r)
            }
            ...
            var h = e("@tensorflow/tfjs-core"),
                d = e("underscore"),
                f = e("../backend/tfjs_backend"),
                g = e("../errors"),
                m = e("../layers/serialization"),
                v = e("../types"),
                y = e("../utils/generic_utils"),
                b = e("../utils/serialization_utils"),
                w = function() {
                    return function(e) {
                ...
                A = function() {
                    function e(e) {
                        ...
                        if (this.name = t, this.trainable = y.pyGetAttr(e, "trainable", !0), this.updatable = y.pyGetAttr(e, "updatable", !0), null != e.inputShape || null != e.batchInputShape) {
                            var r = void 0;
                            if (null != e.batchInputShape) r = e.batchInputShape;
                        ...
                        if (e = y.toList(e), null != this.inputSpec && 0 !== this.inputSpec.length) {
                            ...
                            for (var n = 0; n < e.length; n++) {
                                ...
                                if (null != i) {
                                    ...
                                    if (i.axes)
                                        for (var s = f.intShape(r), u = 0, l = d.pairs(i.axes); u < l.length; u++) {
                                            var c = l[u],
                                                p = c[0],
                                                h = c[1],
                                                m = (p = Number(p)) >= 0 ? s[p] : s[s.length + p];
                                    ...
                                    if (null != i.shape)
                                        for (var s = f.intShape(r), v = 0, b = d.zip(i.shape, s); v < b.length; v++) {
                                            var w = b[v],
                                                x = w[0],
                                                E = w[1];
            ...
            var O = function(e) {
                function t(n) {
                    ...
                    for (var R = 0, I = A.slice().reverse(); R < I.length; R++) {
                        ...
                        var z = v[se.id],
                            M = null == w[se.outboundLayer.id] ? 0 : w[se.outboundLayer.id];
                    ...
                    for (var te = r.inputs.slice(), ne = [], re = 0, ie = Y; re < ie.length; re++)
                        for (var ae = 0, oe = V[z = ie[re]]; ae < oe.length; ae++) {
                            var se = oe[ae];
                ...
                return c(t, e), Object.defineProperty(t.prototype, "trainableWeights", {
                    ...
                    for (var S = [], O = [], r = 0; r < this.outputLayers.length; r++) {
                        var i = this.outputLayers[r],
                            A = this.outputLayersNodeIndices[r],
                    ...
                    for (var l = 0, c = Object.keys(this.nodesByDepth).map(function(e) {
                            return parseInt(e, 10)
                        }).sort(y.reverseNumberCompare); l < c.length; l++)
                        for (var p = c[l], h = 0, f = this.nodesByDepth[p]; h < f.length; h++) {
                    ...
                    for (var r = {}, i = {}, a = t.name, o = t.layers, s = 0, u = o; s < u.length; s++) ! function(e) {
                        var i = e.name,
                            a = m.deserialize(e, null != t.customObjects ? t.customObjects : {});
                        r[i] = a;
                    ...
                    for (var S = 0, O = t.outputLayers; S < O.length; S++) {
                        ...
                        y.assert(E in r);
                        var T = r[E],
                            k = T.inboundNodes[_].outputTensors;
                        b.push(k[A])
                    }
                    return new e({
                        inputs: v,
            ...
            "../backend/tfjs_backend": 96,
            "../errors": 103,
            "../layers/serialization": 117,
            "../types": 124,
            "../utils/generic_utils": 126,
            "../utils/serialization_utils": 128,
            "@tensorflow/tfjs-core": 8,
            underscore: 139
        }],
        102: [function(e, t, n) {
            ...
            function u(e, t, n) {
                for (var r = [A.meanSquaredError, A.binaryCrossentropy, A.categoricalCrossentropy], i = 0; i < e.length; ++i) {
                    ...
                    if (null != o) {
                        ...
                        if (w.contains(r, o))
                            for (var u = a.shape.slice(1), l = s.slice(1), c = 0; c < u.length; ++c) {
                                var p = u[c],
                                    h = l[c];
            ...
            var y = e("@tensorflow/tfjs-core"),
                b = e("@tensorflow/tfjs-core"),
                w = e("underscore"),
                x = e("../backend/tfjs_backend"),
                E = e("../callbacks"),
                _ = e("../errors"),
                A = e("../losses"),
                S = e("../metrics"),
                O = e("../optimizers"),
                T = e("../utils/generic_utils"),
                k = e("./executor"),
                C = e("./topology");
            ...
            var N = function(e) {
                ...
                return f(t, e), t.prototype.compile = function(e) {
                    var t = this;
                    if (null == e.loss && (e.loss = []), this.loss = e.loss, "string" == typeof e.optimizer) this.optimizer = O.getOptimizer(e.optimizer);
                    else {
                    ...
                    var n = [];
                    if (Array.isArray(e.loss) || "string" == typeof e.loss)
                        ...
                        e.loss = e.loss;
                        for (var i in e.loss)
                            if (!w.contains(this.outputNames, i)) throw new _.ValueError('Unknown entry in loss dictionary: "' + i + '". Only expect the following keys: ' + this.outputNames);
                    ...
                    for (var o = 0; o < this.outputs.length; ++o) {
                        var s = this.internalOutputShapes[o],
                            u = this.outputNames[o];
                    ...
                    var c = d(e.metrics, this.outputNames),
                        p = function(e, n, r) {
                    ...
                    var o = this.testFunction,
                        s = this.testLoop(o, a, r, n.verbose, n.steps);
                    ...
                    for (var a = l(i, t), o = [], s = 0; s < a.length; ++s) ! function(t) {
                        ...
                        if (0 === t)
                            for (var i = 0, s = n; i < s.length; i++) {
                                ...
                                for (var l = 0; l < n.length; ++l) o[l] = x.concatAlongFirstAxis(o[l], n[l])
                    }(s);
                                                            ...
                                                            switch (l.label) {
                                                                ...
                                                                case 1:
                                                                    return l.sent(), y.tidy(function() {
                                                                        ...
                                                                        if (i === d.length - 1 && m)
                                                                            for (var E = C.testLoop(s, u, r), y = 0; y < n.length; ++y) {
                                                                                var b = n[y],
                                                                                    w = E[y];
                                                                                x.keep(w), a["val_" + b] = w
                                                                            }
                    ...
                    void 0 === r && (r = 0);
                    var a = this.checkNumSamples(t, n, i, "steps"),
                        o = [];
                    ...
                    for (var s = l(a, n), u = b.tensor1d(w.range(a)), c = 0; c < s.length; ++c) {
                        var h = s[c][0],
                            d = s[c][1],
                            f = e(p(t, x.sliceAlongFirstAxis(u, h, d - h)));
                        if (0 === c)
                            for (m = 0; m < f.length; ++m) o.push(x.getScalar(0));
                    ...
                    return void 0 === n && (n = {}), m(this, void 0, void 0, function() {
                        ...
                        return v(this, function(v) {
                            if (r = null == n.batchSize ? 32 : n.batchSize, i = this.standardizeUserData(e, t, !1, r), a = i[0], o = i[1], s = !1, null != n.validationData && n.validationData.length > 0) {
                                if (s = !0, 2 !== n.validationData.length) throw 3 === n.validationData.length ? new _.NotImplementedError("validationData including sample weights is not supported yet.") : new _.ValueError("When passing validation data, it must contain 2 (valX, valY) or 3 (valX, valY, valSampleWeight) items, however it contains " + n.validationData.length + " items");
                            ...
                            return g = a.concat(o), this.checkTrainableWeightsConsistency(), m = function(e) {
                                var t = [],
                                    n = [],
                                    r = e.slice(0, S.inputs.length),
                                    i = e.slice(S.inputs.length, S.inputs.length + S.outputs.length),
                                    a = [],
                                ...
                                return [S.optimizer.minimize(function() {
                                    ...
                                    for (var s, u = new k.FeedDict(e), l = k.execute(S.outputs, u, {
                                            training: !0
                                        }), o = 0; o < S.lossFunctions.length; ++o) {
                                    ...
                                    for (o = 0; o < S.metricsTensors.length; ++o) {
                                        var h = S.metricsTensors[o][0],
                                            d = S.metricsTensors[o][1],
                                            f = x.mean(h(i[d], l[d]));
                                        x.keep(f), a.push(f)
                                    }
                    ...
                    subheading: "Classes",
                    configParamIndices: [2]
                })], t.prototype, "fit", null), t = g([b.doc({
                    heading: "Models",
                    subheading: "Classes"
                })], t)
            }(C.Container);
        ...
        104: [function(e, t, n) {
            ...
            var _ = function() {
                ...
                return e.inputLayer = function(e) {
                ...
                }, e.avgPooling1d = function(e) {
                    return new v.AvgPooling1D(e)
                }, e.avgPooling2d = function(e) {
                    return new v.AvgPooling2D(e)
                    ...
                    configParamIndices: [0]
                })], e, "avgPooling1d", null), r([i.doc({
                    heading: "Layers",
                    subheading: "Pooling",
                    namespace: "layers",
                    useDocsFrom: "AvgPooling2D",
                    configParamIndices: [0]
                })], e, "avgPooling2d", null), r([i.doc({
                    heading: "Layers",
                    subheading: "Pooling",
                    namespace: "layers",
            ...
            "./engine/training": 102,
            "./initializers": 106,
            "./layers/advanced_activations": 107,
            "./layers/convolutional": 108,
            "./layers/convolutional_depthwise": 109,
            "./layers/core": 110,
            "./layers/embeddings": 111,
            "./layers/merge": 112,
            "./layers/normalization": 113,
            "./layers/padding": 114,
            "./layers/pooling": 115,
            "./layers/recurrent": 116,
            "./layers/wrappers": 118,
            "./models": 121,
            "./regularizers": 123,
            "@tensorflow/tfjs-core": 8
        ...
        106: [function(e, t, n) {
            ...
            function a(e, t) {
                ...
                var n, r;
                if (h.checkDataFormat(t), 2 === e.length) n = e[0], r = e[1];
                else if (c.contains([3, 4, 5], e.length)) {
                    if ("channelsFirst" === t) {
                        i = m.arrayProd(e, 2);
                        n = e[1] * i, r = e[0] * i
            ...
            var l = e("@tensorflow/tfjs-core"),
                c = e("underscore"),
                p = e("./backend/tfjs_backend"),
                h = e("./common"),
                d = e("./errors"),
                f = e("./types"),
            ...
            var N = function(e) {
                ...
                return s(t, e), t.prototype.apply = function(e, t) {
                    ...
                    var n = e[0] >= e[1] ? e : [e[1], e[0]],
                        r = p.randomNormal(n, 0, 1, f.DType.float32),
                        i = p.qr(r)[0];
        ...
        108: [function(e, t, n) {
            ...
            var i = e("@tensorflow/tfjs-core"),
                ...
                d = e("../regularizers"),
                f = e("../types"),
                g = e("../utils/conv_utils"),
                m = e("../utils/generic_utils"),
                v = function(e) {
                    function t(t, n) {
                        var r = e.call(this, n) || this;
                        if (r.kernel = null, r.bias = null, r.DEFAULT_KERNEL_INITIALIZER = "glorotNormal", r.DEFAULT_BIAS_INITIALIZER = "zeros", r.rank = t, 1 !== r.rank && 2 !== r.rank) throw new p.NotImplementedError("Convolution layer for rank other than 1 or 2 (" + r.rank + ") is not implemented yet.");
                        if (r.filters = n.filters, r.kernelSize = g.normalizeArray(n.kernelSize, t, "kernelSize"), r.strides = g.normalizeArray(null == n.strides ? 1 : n.strides, t, "strides"), r.padding = null == n.padding ? "valid" : n.padding, u.checkPaddingMode(r.padding), r.dataFormat = null == n.dataFormat ? "channelsLast" : n.dataFormat, u.checkDataFormat(r.dataFormat), r.dilationRate = null == n.dilationRate ? 1 : n.dilationRate, !(1 === r.dilationRate || Array.isArray(r.dilationRate) && a.isEqual(a.uniq(r.dilationRate), [1]))) throw new p.NotImplementedError("Non-default dilation is not implemented for convolution layers yet.");
                        return r.activation = o.getActivation(n.activation), r.useBias = null == n.useBias || n.useBias, r.kernelInitializer = h.getInitializer(n.kernelInitializer || r.DEFAULT_KERNEL_INITIALIZER), r.biasInitializer = h.getInitializer(n.biasInitializer || r.DEFAULT_BIAS_INITIALIZER), r.kernelConstraint = l.getConstraint(n.kernelConstraint), r.biasConstraint = l.getConstraint(n.biasConstraint), r.kernelRegularizer = d.getRegularizer(n.kernelRegularizer), r.biasRegularizer = d.getRegularizer(n.biasRegularizer), r.activityRegularizer = d.getRegularizer(n.activityRegularizer), r
                    }
                    return r(t, e), t.prototype.build = function(e) {
                        e = m.getExactlyOneShape(e);
                        var t = "channelsFirst" === this.dataFormat ? 1 : e.length - 1;
                        if (null == e[t]) throw new p.ValueError("The channel dimension of the input should be defined. Found " + e[t]);
                        var n = e[t],
                        ...
                        e = m.getExactlyOneTensor(e);
                        var n, r = null == this.bias ? null : this.bias.read();
                        if (1 === this.rank) n = s.conv1dWithBias(e, this.kernel.read(), r, this.strides[0], this.padding, this.dataFormat);
                        else if (2 === this.rank) n = s.conv2dWithBias(e, this.kernel.read(), r, this.strides, this.padding, this.dataFormat);
                        else if (3 === this.rank) throw new p.NotImplementedError("3D convolution is not implemented yet.");
                        ...
                        for (var t = [], n = "channelsLast" === this.dataFormat ? e.slice(1, e.length - 1) : e.slice(2), r = 0; r < n.length; ++r) {
                            var i = g.convOutputLength(n[r], this.kernelSize[r], this.padding, this.strides[r], "number" == typeof this.dilationRate ? this.dilationRate : this.dilationRate[r]);
                            t.push(i)
                        }
                        var a = [e[0]];
            ...
            n.Conv2D = y, m.ClassNameMap.register("Conv2D", y);
            var b = function(e) {
                function t(t) {
                    var n = e.call(this, t) || this;
                    if (n.inputSpec = [new c.InputSpec({
                            ndim: 4
                        })], "same" !== n.padding && "valid" !== n.padding) throw new p.ValueError("Conv2DTranspose currently supports only padding modes 'same' and 'valid', but received padding mode " + n.padding);
                    return n
                }
                return r(t, e), t.prototype.build = function(e) {
                    if (4 !== (e = m.getExactlyOneShape(e)).length) throw new p.ValueError("Input should have rank 4; Received input shape: " + JSON.stringify(e));
                    var t = "channelsFirst" === this.dataFormat ? 1 : e.length - 1;
                    if (null == e[t]) throw new p.ValueError("The channel dimension of the inputs should be defined. Found `None`.");
                    var n = e[t],
                        r = this.kernelSize.concat([this.filters, n]);
                    this.kernel = this.addWeight("kernel", r, f.DType.float32, this.kernelInitializer, this.kernelRegularizer, !0, this.kernelConstraint), this.useBias && (this.bias = this.addWeight("bias", [this.filters], f.DType.float32, this.biasInitializer, this.biasRegularizer, !0, this.biasConstraint)), this.inputSpec = [new c.InputSpec({
                        ndim: 4,
                        axes: (i = {}, i[t] = n, i)
                    })], this.built = !0;
                    var i
                    ...
                    return i.tidy(function() {
                        var t = m.getExactlyOneTensor(e);
                        if (4 !== t.shape.length) throw new p.ValueError("Conv2DTranspose.call() expects input tensor to be rank-4, but received a tensor of rank-" + t.shape.length);
                        var r, a, o = t.shape,
                            u = o[0];
                        ...
                        var l = o[r],
                            ...
                            f = n.strides[0],
                            v = n.strides[1],
                            y = [u, g.deconvLength(l, f, h, n.padding), g.deconvLength(c, v, d, n.padding), n.filters];
                        "channelsLast" !== n.dataFormat && (t = s.transpose(t, [0, 2, 3, 1]));
                        var b = i.conv2dTranspose(t, n.kernel.read(), y, n.strides, n.padding);
                        return "channelsLast" !== n.dataFormat && (b = s.transpose(b, [0, 3, 1, 2])), null != n.bias && (b = s.biasAdd(b, n.bias.read(), n.dataFormat)), null != n.activation && (b = n.activation(b)), b
                    })
                }, t.prototype.computeOutputShape = function(e) {
                    var t, n, r, i = (e = m.getExactlyOneShape(e)).slice();
                    "channelsFirst" === this.dataFormat ? (t = 1, n = 2, r = 3) : (t = 3, n = 1, r = 2);
                    var a = this.kernelSize[0],
                        o = this.kernelSize[1],
                        s = this.strides[0],
                        u = this.strides[1];
                    return i[t] = this.filters, i[n] = g.deconvLength(i[n], s, a, this.padding), i[r] = g.deconvLength(i[r], u, o, this.padding), i
                }, t.prototype.getConfig = function() {
                    var t = e.prototype.getConfig.call(this);
                    return delete t.dilationRate, t
                }, t
            }(y);
            n.Conv2DTranspose = b, m.ClassNameMap.register("Conv2DTranspose", b);
            var w = function(e) {
                function t(t) {
            ...
            n.Conv1D = w, m.ClassNameMap.register("Conv1D", w)
        }, {
            "../activations": 94,
            "../backend/tfjs_backend": 96,
            "../common": 98,
                    ...
                    return r(t, e), t.prototype.mergeFunction = function(e) {
                        ...
                        if (e = e, this.reshapeRequired) {
                            ...
                            if (i.contains(r, null)) {
                                ...
                                var f = this.mergeFunction(n),
                                    g = a.ndim(f);
                                if (o)
                                    if (null == g) {
                                        var m = a.shape(f),
                                            h = [p = m[m.length - 1]].concat(m.slice(0, m.length - 1));
            ...
            var i = e("underscore"),
                ...
                h = function(e) {
                    ...
                    return r(t, e), t.prototype.build = function(e) {
                        ...
                        this.inputSpec = [new s.InputSpec({
                            ndim: e.length,
                            axes: (i = {}, i[t] = n, i)
                        })];
                        var r = [n];
                        ...
                        var n = this,
                            r = null != t.training && t.training,
                            o = p.getExactlyOneTensor(e),
                            s = a.shape(o),
                            l = s.length,
                            c = i.range(l),
                            h = this.axis >= 0 ? this.axis : this.axis + l;
                        c.splice(h, 1);
        ...
        114: [function(e, t, n) {
            ...
            var i = e("../backend/common"),
                ...
                l = function(e) {
                    function t(t) {
                        var n = this;
                        if (null == t && (t = {}), n = e.call(this, t) || this, n.dataFormat = null == t.dataFormat ? i.imageDataFormat() : t.dataFormat, null == t.padding) n.padding = [
                            [1, 1],
                            [1, 1]
                        ];
                        ...
                        return n.inputSpec = [new o.InputSpec({
                            ndim: 4
                        })], n
                    }
                    return r(t, e), t.prototype.computeOutputShape = function(e) {
        ...
        115: [function(e, t, n) {
            ...
            var i = e("../backend/tfjs_backend"),
                ...
                p = function(e) {
                    function t(t) {
                        var n = this;
                        return null == t.poolSize && (t.poolSize = 2), n = e.call(this, t) || this, n.poolSize = [t.poolSize], n.strides = null == t.strides ? n.poolSize : [t.strides], n.padding = null == t.padding ? "valid" : t.padding, a.checkPaddingMode(n.padding), n.inputSpec = [new o.InputSpec({
                            ndim: 3
                        })], n
                    }
                    return r(t, e), t.prototype.computeOutputShape = function(e) {
            ...
            n.AvgPooling1D = d, c.ClassNameMap.register("AvgPooling1D", d);
            var f = function(e) {
                function t(t) {
                    var n = this;
                    return null == t.poolSize && (t.poolSize = [2, 2]), n = e.call(this, t) || this, n.poolSize = Array.isArray(t.poolSize) ? t.poolSize : [t.poolSize, t.poolSize], n.strides = null == t.strides ? n.poolSize : t.strides, n.padding = null == t.padding ? "valid" : t.padding, n.dataFormat = null == t.dataFormat ? "channelsLast" : t.dataFormat, a.checkDataFormat(n.dataFormat), a.checkPaddingMode(n.padding), n.inputSpec = [new o.InputSpec({
                        ndim: 4
                    })], n
                }
                return r(t, e), t.prototype.computeOutputShape = function(e) {
            ...
            n.AvgPooling2D = m, c.ClassNameMap.register("AvgPooling2D", m);
            var v = function(e) {
                function t(t) {
                    var n = e.call(this, t) || this;
                    return n.inputSpec = [new o.InputSpec({
            ...
            var w = function(e) {
                function t(t) {
                    var n = e.call(this, t) || this;
                    return n.dataFormat = null == t.dataFormat ? "channelsLast" : t.dataFormat, a.checkDataFormat(n.dataFormat), n.inputSpec = [new o.InputSpec({
                        ndim: 4
                    })], n
                }
                return r(t, e), t.prototype.computeOutputShape = function(e) {
        ...
        116: [function(e, t, n) {
            ...
            var a = e("@tensorflow/tfjs-core"),
                ...
                g = e("../types"),
                m = e("../utils/generic_utils"),
                v = e("../utils/math_utils"),
                y = e("./serialization"),
                b = function(e) {
                    function t(t) {
                        var n, r = e.call(this, t) || this;
                        if (null == t.cell) throw new h.ValueError("cell property is missing for the constructor of RNN.");
                        if (null == (n = Array.isArray(t.cell) ? new T({
                                cells: t.cell
                            }) : t.cell).stateSize) throw new h.ValueError("The RNN cell should have an attribute `stateSize` (tuple of integers, one integer per RNN state).");
                        return r.cell = n, r.returnSequences = null != t.returnSequences && t.returnSequences, r.returnState = null != t.returnState && t.returnState, r.goBackwards = null != t.goBackwards && t.goBackwards, r._stateful = null != t.stateful && t.stateful, r.unroll = null != t.unroll && t.unroll, r.supportsMasking = !0, r.inputSpec = [new c.InputSpec({
                            ndim: 3
                        })], r.stateSpec = null, r.states = null, r.numConstants = null, r
                    }
                    return r(t, e), t.prototype.getStates = function() {
                        ...
                        var t = this.stateful ? e[0] : null,
                            n = e[e.length - 1];
                        this.inputSpec[0] = new c.InputSpec({
                            shape: [t, null, n]
                        });
                        ...
                        if (null == this.states) Array.isArray(this.cell.stateSize) ? this.states = this.cell.stateSize.map(function(e) {
                            return u.zeros([t, e])
                        }) : this.states = [u.zeros([t, this.cell.stateSize])];
                        else if (null == e) Array.isArray(this.cell.stateSize) ? this.states = this.cell.stateSize.map(function(e) {
                            return u.zeros([t, e])
                        }) : this.states[0] = u.zeros([t, this.cell.stateSize]);
                        else {
                        ...
                        if (null != r) {
                            ...
                            for (var u = 0, l = r; u < l.length; u++) {
                                var p = l[u];
                                this.stateSpec.push(new c.InputSpec({
                                    shape: p.shape
                                }))
                            }
                        ...
                        var l = {
                            ...
                            c = u.rnn(function(e, t) {
                                var r = n.cell.call([e].concat(t), l);
                                return [r[0], r.slice(1)]
                            }, e, a, this.goBackwards, null, null, this.unroll, s),
                            p = c[0],
                            d = c[1],
                            f = c[2];
                        if (this.stateful) throw new h.NotImplementedError("stateful RNN layer is not implemented yet");
                ...
                return r(t, e), t.prototype.build = function(e) {
                    ...
                    if (1 === this.implementation) {
                        var o = u.sliceAlongLastAxis(this.kernel.read(), 0, this.units),
                            ...
                            d = u.sliceAlongLastAxis(this.recurrentKernel.read(), 2 * this.units, this.units),
                            f = e,
                            g = e,
                            m = e,
                            v = u.dot(f, o),
                ...
                return r(t, e), t.prototype.build = function(e) {
                    ...
                    if (1 === this.implementation) {
                        var l = u.sliceAlongLastAxis(this.kernel.read(), 0, this.units),
                            ...
                            v = u.sliceAlongLastAxis(this.recurrentKernel.read(), 3 * this.units, this.units),
                            y = e,
                            b = e,
                            w = e,
                            x = e,
        ...
        118: [function(e, t, n) {
            ...
            var i = e("../backend/tfjs_backend"),
                ...
                l = function(e) {
                    function t(t) {
                        var n = e.call(this, t) || this;
                        return n.layer = t.layer, n.inputMap = {}, n
                    }
                    return r(t, e), t.prototype.build = function(e) {
                        this.built = !0
            ...
            var h = function(e) {
                ...
                return r(t, e), Object.defineProperty(t.prototype, "trainable", {
                    ...
                    var n, r = this.forwardLayer.call(e, t),
                        a = this.backwardLayer.call(e, t);
        ...
        119: [function(e, t, n) {
            ...
            function s(e, t) {
                var n = v.getScalar(0),
                    r = v.getScalar(1),
                    i = v.maximum(n, v.subtract(r, v.multiply(e, t)));
        ...
        120: [function(e, t, n) {
            ...
            function r(e, t) {
                var n = o.scalarTimesArray(o.getScalar(.5), a.onesLike(t)),
                    r = o.cast(o.greater(t, n), e.dtype);
        ...
        121: [function(e, t, n) {
                ...
                return o(this, void 0, void 0, function() {
                    ...
                    return s(this, function(s) {
                        switch (s.label) {
                            ...
                            case 1:
                                a = s.sent(), o = null, l = !0, i.loadWeights(a, o, l), s.label = 2;
                            case 2:
                                return [2, i]
                        }
                    })
            ...
            var m = function(e) {
                function t(t) {
                    ...
                    if (t = t || {}, n.trainable = !0, n._updatable = !0, n.built = !1, n.name = null != t.name ? t.name : l.getUid("sequential_"), null != t.layers)
                ...
                return i(t, e), n = t, t.prototype.add = function(e) {
                    ...
                    subheading: "Classes",
                    configParamIndices: [2]
                })], t.prototype, "fit", null), t = n = a([u.doc({
                    heading: "Models",
                    subheading: "Classes"
                })], t);
                var n
        ...
        123: [function(e, t, n) {
            ...
            n.L1L2 = c, u.ClassNameMap.register("L1L2", c), n.l1 = function(e) {
                ...
                l1l2: "L1L2"
            }, n.serializeRegularizer = function(e) {
        ...
        124: [function(e, t, n) {
            ...
            var o, s = e("@tensorflow/tfjs-core"),
                u = e("./common");
            ! function(e) {
                e.float32 = "float32", e.int32 = "int32", e.bool = "bool"
            }(o = n.DType || (n.DType = {}));
            var l = 0,
                c = function() {
                    function e(e, t, n, r, i, a, o) {
                        this.dtype = e, this.shape = t, this.sourceLayer = n, this.inputs = r, this.callArgs = i, this.outputTensorIndex = o, this.id = l++, null != a && (this.name = u.getUniqueTensorName(a))
                    }
                    return e = a([s.doc({
                        heading: "Models",
                        subheading: "Classes"
            ...
            var p = function() {
                function e(e, t) {
                    this.dtype = o.float32, this.shape = e.shape, this.val = e, this.id = l++, null != t && (this.name = u.getUniqueTensorName(t))
                }
            ...
            var h = "Variable",
                d = function() {
                    function e(e, t, n, r, a) {
                        void 0 === t && (t = o.float32), void 0 === n && (n = h), void 0 === r && (r = !0), void 0 === a && (a = null), this.dtype = null == t ? o.float32 : t, this.shape = e.shape, this.id = l++, this.name = u.getUniqueTensorName(null == n ? h : n), this.trainable = r, this.constraint = a, this.val = s.variable(i(e), this.trainable, this.name, this.dtype)
                    }
            ...
            n.serializeKerasObject = function(e) {
                ...
                if (void 0 === t && (t = {}), void 0 === n && (n = {}), void 0 === r && (r = "object"), "string" == typeof e) {
                    var i = e,
                        u = void 0;
                    if (i in n) u = n[i];
                    else if (i in p) u = p[i];
                    else if (null == (u = t[i])) throw new s.ValueError("Unknown " + r + ": " + e);
                    return u
                }
                var l = e;
        ...
        128: [function(e, t, n) {
            ...
            function i(e, t) {
                ...
                for (var c = {}, p = 0, h = Object.keys(e); p < h.length; p++) {
                    var d = h[p],
                        f = e[d];
                    if ("name" === d && "string" == typeof f) c[d] = f;
                    else {
                        var g = s.toCamelCase(d);
                        if (!s.SerializableEnumRegistry.contains(d) || "string" != typeof f && null != f) c[g] = i(f, g);
                        else {
            ...
            function a(e, t) {
                ...
                for (var l = {}, c = 0, p = Object.keys(e); c < p.length; c++) {
                    var h = p[c],
                        d = e[h],
                        f = s.toSnakeCase(h);
                    if ("name" !== h && "className" !== h || "string" != typeof d)
                        if (!s.SerializableEnumRegistry.contains(f) || "string" != typeof d && null != d) l[f] = a(d, h);
                        else {
            ...
            ! function(n, r) {
                function i(e, t, i) {
                    var p = [],
                        h = u(s((t = 1 == t ? {
                            entropy: !0
                        } : t || {}).entropy ? [e, c(n)] : null == e ? l() : e, 3), p),
                        b = new a(p),
                        w = function() {
            ...
            (function() {
                ...
                w.each = w.forEach = function(e, t, n) {
                    ...
                    var r, i, a = -1 / 0,
                        o = -1 / 0;
                    if (null == t && null != e)
                        for (var s = 0, u = (e = k(e) ? e : w.values(e)).length; s < u; s++)(r = e[s]) > a && (a = r);
                    else t = E(t, n), w.each(e, function(e, n, r) {
                ...
                w.keys = function(e) {
                    ...
                    t = E(t, n);
                    for (var r, i = w.keys(e), a = 0, o = i.length; a < o; a++)
                ...
                var M = function(e, t, n, r) {
                    ...
                    if (n.push(e), r.push(t), a) {
                        ...
                        for (; u--;)
                            if (l = c[u], !w.has(t, l) || !M(e[l], t[l], n, r)) return !1
                    }
        ...
        140: [function(e, t, n) {
            ...
            Object.defineProperty(n, "__esModule", {
                value: !0
            }), r(e("@tensorflow/tfjs-core")), r(e("@tensorflow/tfjs-layers"));
            var i = e("@tensorflow/tfjs-core"),
                a = e("@tensorflow/tfjs-layers"),
                o = e("./version");
            n.version = {
                "tfjs-core": i.version_core,
                "tfjs-layers": a.version_layers,
                tfjs: o.version
            }
        }, {
            "./version": 141,
            "@tensorflow/tfjs-core": 8,
            "@tensorflow/tfjs-layers": 105
        }],
        141: [function(e, t, n) {
            "use strict";
            Object.defineProperty(n, "__esModule", {
